...
import { message, UploadFile,Button } from 'antd';
    ...
    <ProCard>
      ...
      {(!id || oldData) && (
        ...
        >
          ...
          >	 
					 <Button onClick={() => setInputModelConfigVisible(true)}>导入模型配置</Button>
					<ModelInfoConfig
          ...
          >
				<Button onClick={() => setInputFileConfigVisible(true)}>导入文件配置</Button>
				<FileInfoConfig

export const DEFAULT_NAME = 'SQL生成工具';
...
export const DEFAULT_ADD_TABLE: TableData = {
 ...
 * 模拟类型列表
 */
export const MOCK_TYPE_LIST = ['固定', '随机', '递增', '规则', '词库','关联', '不模拟'];
 ...
 * COS 访问地址
 */
export const COS_HOST = "https://service-edu-2000.oss-cn-hangzhou.aliyuncs.com";

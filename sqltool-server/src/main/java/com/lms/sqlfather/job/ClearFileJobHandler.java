...
@Component
@Slf4j
public class ClearFileJobHandler {

    @Resource
    private OssClient cosManager;
    ...
    public void clearCosJobHandler() throws Exception {
        ...
        cosManager.deleteObject(FileConstant.BUCKET_NAME,"/generator_make_template/");
        ...
        cosManager.deleteObjects(FileConstant.BUCKET_NAME,keyList);

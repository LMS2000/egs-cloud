...
public class PostFavourController {
    ...
    public Integer doPostFavour(@RequestBody PostFavourAddRequest postFavourAddRequest) {
        BusinessException.throwIf(postFavourAddRequest == null || postFavourAddRequest.getPostId() <= 0);
        // 登录才能操作
    ...
    public Page<PostVO> listMyFavourPostByPage(@RequestBody PostFavourQueryRequest postFavourQueryRequest) {
        Long loginId =Long.parseLong((String) StpUtil.getLoginId());

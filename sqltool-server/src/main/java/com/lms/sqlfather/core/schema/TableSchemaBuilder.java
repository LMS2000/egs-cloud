package com.lms.sqlfather.core.schema;
...
public class TableSchemaBuilder {
    ...
    public static TableSchema buildFromAuto(String content) {
        ...
        queryWrapper.in("name", Arrays.asList(words)).or().in("field_name", Arrays.asList(words));
    ...
    public static TableSchema buildFromExcel(MultipartFile file) {
        try {
            ...
            table.setFieldList(fieldList);
            table.setTableComment("excel导入的表");
            table.setTableName("my_table");
            tableSchema.setTableList(List.of(table));
            return tableSchema;
        } catch (Exception e) {

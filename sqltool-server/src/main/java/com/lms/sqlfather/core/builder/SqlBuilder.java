...
public class SqlBuilder {
    ...
    public String buildCreateTableSql(TableSchema tableSchema) {
        ...
        tableSchema.getTableList().forEach(table -> {
            ...
            //封装表前表后注释
            String prefixComment = StringUtils.isNotBlank(table.getTableComment())? String.format("--%s", table.getTableComment()):"";

            String suffixComment =StringUtils.isNotBlank(table.getTableComment())? String.format("comment %s", table.getTableComment()):"";
     ...
     * @return
     */
    public String buildInsertSql(TableSchema tableSchema,Map<String,List<Map<String,Object>>> insertDataMap) {
        ...
        tableSchema.getTableList().forEach(table -> {
            ...
            resultBuilder.append(stringBuilder.toString()).append("\n");
